...
- DSH has no grok `scheduler_create`. The [Autonomous run playbook](../../skills/poteto-mode/playbooks/autonomous-run.md) uses `create_goal` when that tool is present, otherwise it keeps iterating in this chat.
