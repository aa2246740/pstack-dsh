...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation with `pstack_spawn` `role: bug-fix` (overlay or inherit) and a specific scope; review the diff.
