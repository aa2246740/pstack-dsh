...
1. Write a kebab-case `SKILL.md` (`name` matches `^[a-z0-9]+(?:-[a-z0-9]+)*$`). DSH drops `name: Poteto Mode`. Follow the **authoring-a-skill** playbook; this port does not ship Cursor `create-skill`.
